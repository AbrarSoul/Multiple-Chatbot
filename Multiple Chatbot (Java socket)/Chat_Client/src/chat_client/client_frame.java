...
public class client_frame extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        b_connect.setForeground(new java.awt.Color(0, 255, 0));
        ...
        b_send.setForeground(new java.awt.Color(0, 153, 102));
        b_send.setText("SEND");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(tf_chat, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(81, 81, 81)
    ...
    private void b_connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_connectActionPerformed
        if (isConnected == false) 
        {
            ...
            try 
            {
                ...
                writer.flush(); // buffer k clear kore dilam
                isConnected = true; 
            } 
            catch (Exception ex) 
            {
